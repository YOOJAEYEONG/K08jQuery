...
public class NaverSearchAPI extends HttpServlet{
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
	 	...
	 	String clientId = "TEq26TUYB7G4TCxD1KQz"; //애플리케이션 클라이언트 아이디값"
        String clientSecret = "wNcTgkE_au"; //애플리케이션 클라이언트 시크릿값"
        ...
        try {
        	...
        	start = req.getParameter("startNum");
        ...
        String apiURL = "https://openapi.naver.com/v1/search/blog?query="
        		+text+"&display="+display+"&start="+start;    // json 결과
